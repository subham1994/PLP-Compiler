...
public class PLPImage {
	...
	public BufferedImage getImgIfDimensionsMatch (Dimension dimension, int line, int pil) throws PLPImageException {
		if (dimension == null || dimension.height != getHeightThrows(line, pil) ||
				dimension.width != getWidthThrows(line, pil))
			throw new PLPImageException(line, pil, "Dimensions do not match for the given image pair");
		return image;
	}

	public void assertImageIsNotNull (int line, int posInLine) throws PLPImageException {
